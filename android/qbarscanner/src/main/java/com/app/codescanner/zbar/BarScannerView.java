package com.app.codescanner.zbar;
...
public class BarScannerView extends BarcodeScannerView {
    ...
    public BarScannerView(Context context) {
        super(context);
        setupScanner();
    }

    public BarScannerView(Context context, AttributeSet attributeSet) {
